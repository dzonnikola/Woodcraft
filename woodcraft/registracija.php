        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Registracija</h1>
                <form action="regProcess.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="pwd" class="form-control" placeholder="Vaša lozinka">
                  </div> 
                  <div class="form-group">
                    <label for="passwordretype">Ponovo unesite lozinku</label>
                    <input type="password" name="pwdre" class="form-control" placeholder="Ponovljena lozinka">
                  </div>                  
